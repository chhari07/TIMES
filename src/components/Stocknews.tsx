  ...
  const fetchNews = async () => {
    ...
    try {
      const response = await axios.get(
        "https://newsdata.io/api/1/news?apikey=pub_60272c028e393a4834346618e4e4db87599b0&q=stock&country=in&language=en&category=business,world    "
      );
  ...
  return (
    <div className="bg-black text-white">
      <div className="container mx-auto mt-32 p-4">
        <div className="mb-6">
          <h1 className="text-3xl font-semibold">Latest Stock News</h1>
          <p className="text-gray-300">Stay updated with the latest Stock trends and headlines.</p>
        </div>
